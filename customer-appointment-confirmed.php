      ...
      <tbody>
        <tr>
          <td style="mso-line-height-rule:exactly">
            <table align="center" cellpadding="0" cellspacing="0" class="w-100p" style="max-width:600px; margin:0 auto;border: 1px solid lightgray;" width="600">

              <!-- preview -->
              <tbody>
                <tr>
                  <td style="mso-line-height-rule:exactly; display:none; font-size:0; line-height:0">

                    <!-- Preview text goes here -->We dared to compare.
                    ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣ ⁣
                  </td>
                </tr>
                ...
                <!-- section -->
                <tr>
                  <td style="mso-line-height-rule:exactly; background-color: #55CECF;">

                    <!--[if gte mso 9]>
									<v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px; height:756px;">
										<v:fill type="tile" src="https://d3k81ch9hvuctc.cloudfront.net/company/Hw5AKU/images/bg-01d370e.jpg" color="#5e5649" />
										<v:textbox style="padding-top:0; padding-right:0; padding-bottom:0; padding-left:0;">
											<![endif]-->
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        <tr>
                          <td class="h-a"  style="mso-line-height-rule:exactly" width="15"></td>
                          <td style="mso-line-height-rule:exactly" valign="top">
                            <table cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td class="l-white" style="mso-line-height-rule:exactly; padding:10px 0 0">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                          ...
                          <td style="mso-line-height-rule:exactly" width="15"></td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <!-- section -->
                <tr>
                  <td style="mso-line-height-rule:exactly; padding:37px 15px 6px">
                        ...
                        <tr>
                          <td style="mso-line-height-rule:exactly; padding:0 0 21px">
                            <table cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td style="mso-line-height-rule:exactly; padding:17px 15px 21px 15px;background-color: #EFF1F1; border-radius: 25px;" >
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        <tr >
                                          ...
                                          <td align="left" style="mso-line-height-rule:exactly; padding:0px 25px 13px; font:20px/35px Arial, Helvetica, sans-serif; color:#3B2B6E; letter-spacing:0.6px">
											...
											<?php $wc_order = $appointment->get_order(); ?>
                                              Total
                                            <br class="hm">
                                            <strong><?php if($wc_order) echo $wc_order->get_total()?> €</strong>
                                        ...
                                        <!-- <tr>
                                          <td align="center" style="mso-line-height-rule:exactly; font:12px/16px Arial, Helvetica, sans-serif; color:#000; letter-spacing:0.6px">
                                            — Stephen H.
                                          </td>
                                        </tr> -->
                                      </tbody>
                  ...
                  <td class="ptb-30" style="mso-line-height-rule:exactly; background:#fff; padding:10px 15px">
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td class="pb-30" style="mso-line-height-rule:exactly; padding:0 0 49px">
                            <table align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                              <tbody>
                                <tr>
								<?php
									if ($wc_order) {
										$object=new WC_Appointments_ICS_Exporter();
										$url=$object->get_appointment_ics( $appointment );
										$url=explode("/",$url);
										$download_url="https://www.olistique.be/wp-content/uploads/2022/04/".end($url);										
									}
								?>
                        ...
                        <tr>
                          <td class="pb-20" style="mso-line-height-rule:exactly; padding:0 0 40px">
                            <table align="center" cellpadding="0" cellspacing="0" style="width:100% !important; max-width:300px; margin:0 auto;" width="300">
                              <tbody>
                                <tr>
                                  <td height="1" style="mso-line-height-rule:exactly; background:#ddd; font-size:1px; line-height:1px; color:ddd">
                                    .
                                  </td>
                                </tr>
                              </tbody>
                        ...
                        <tr>
                          <td align="center" style="mso-line-height-rule:exactly; padding:0 0 26px; font:10px/20px Arial, Helvetica, sans-serif; color:#3B2B6E; text-transform:uppercase; letter-spacing:0.5px">
                            <strong>Veuillez ne pas repondre a cet e-mail.</strong><br>
                            <span class="ns" style="color:#3B2B6E;"><strong>Une question? contactez-nous via info@olistique.be</strong></span>
                          </td>
                        </tr>
                        <tr>
                          <td style="mso-line-height-rule:exactly">
